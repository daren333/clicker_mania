...
def get_click(click_timestamp: str):
    ...
    return clicks_db_service.get_click(click_timestamp=click_timestamp)


def get_all_clicks(trick_id: str):
    """Get all clicks for a given trick id"""
    return clicks_db_service.get_all_clicks_by_trick(trick_id=trick_id)