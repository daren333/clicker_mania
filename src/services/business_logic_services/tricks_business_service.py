...
def get_trick(user_id: str, pet_id: str, trick_id: str):
    return tricks_db_service.get_trick(user_id=user_id, pet_id=pet_id, trick_id=trick_id)
...
def update_trick(user_id, pet_id, trick_id, new_name):
    ...
    if trick:
        ...
        trick.name = new_name
        updated_trick = tricks_db_service.update_trick(trick_id=trick_id, trick_obj=trick)
...
def delete_trick(user_id, pet_id, trick_id):
    return tricks_db_service.delete_trick(user_id=user_id, pet_id=pet_id, trick_id=trick_id)
